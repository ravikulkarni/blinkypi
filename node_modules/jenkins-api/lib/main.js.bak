...
<<<<<<< HEAD
            if (typeof params === 'function') { 
                ...
                buildurl = build_url(BUILDWITHPARAMS+"?"+params, jobname)
            }
...
=======
            if (!params) {
		reqUrl = build_url(BUILD, jobname);
            }else {
		reqUrl = build_url(BUILDWITHPARAMS+"?"+qs.stringify(params), jobname);
            }
            request({method: 'POST', url: reqUrl}, callback);
>>>>>>> kaanon/master
        },
